...
def Output_Excel(number_runs):
    ...
    for i in range(13):
        EDbest2_parcials.append(0)

    # Workbook is created 
    wb = Workbook() 

    # add_sheet is used to create sheet. 
    sheet1 = wb.add_sheet('Best_2')
    ...
    for run in range(number_runs):
        ...
        BEST, BEST_PAR, NUM_RUNS, SUCCESS = Best_2()
        ...
        for index1 in range(len(BEST_PAR)):
            ...
            EDbest2_parcials[index1] += BEST_PAR[index1]/number_runs
    ...
    wb.save("CEC2014 Function" + str(Funtion_number) + " - ED_class" + str(dim) + "teste.xls") 

    return success_rate/number_runs, EDbest2_parcials

Results, EDbest2_parcials = Output_Excel(25)
print("Sucess rate: ", Results)
print("Parcials Average: ", EDbest2_parcials)